...
public class DoubleSolenoidHardware extends DoubleHardware<PCM>
{
	...
	{
		this(new CAN(1), requestedPort1, requestedPort2, registry);
	}

	public DoubleSolenoidHardware(CAN moduleID, PCM requestedPort1, PCM requestedPort2, Registry registry)
	{
	...
	{
		doubleSolenoid = Optional.of(new DoubleSolenoid(moduleID.index(), port1.index(), port2.index()));
	}
