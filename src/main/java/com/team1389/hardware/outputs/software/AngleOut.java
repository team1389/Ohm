 ...
 * @author Kenneth
 * @param <T>
 *            the value type of the stream (position or speed)
 *
 */
public class AngleOut<T extends PIDTunableValue> extends RangeOut<T>
{
	/**
	 * allows this stream to map angle values from angle range to a different
	 * range
	 * 
	 * @param out
	 *                stream to be operated on
	 */
